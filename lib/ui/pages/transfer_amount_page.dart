...
class TransferAmaountPage extends StatefulWidget {
  final TransferFormModel data;

  const TransferAmaountPage({
    Key? key,
    required this.data,
  }) : super(key: key);

  @override
  State<TransferAmaountPage> createState() => _TransferAmaountPageState();
}

class _TransferAmaountPageState extends State<TransferAmaountPage> {
