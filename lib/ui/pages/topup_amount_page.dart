...
class TopupAmaountPage extends StatefulWidget {
  final TopupFormModel data;

  const TopupAmaountPage({Key? key, required this.data}) : super(key: key);

  @override
  State<TopupAmaountPage> createState() => _TopupAmaountPageState();
}

class _TopupAmaountPageState extends State<TopupAmaountPage> {
